...
public class TrailDAO extends JPACrud<Trail, Long> {
	...
	public List<Trail> findByNamedQuerySystemAndObjectAndIdName(String namedQuery, String system, String object,
