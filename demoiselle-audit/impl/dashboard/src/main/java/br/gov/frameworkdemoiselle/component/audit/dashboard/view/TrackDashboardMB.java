...
public class TrackDashboardMB implements Serializable {
	...
	public void search(ActionEvent event){
		...
		if(objectIdValue != null && !"".equals(objectIdValue)){
			...
			List<Trail> trails = trailBC.findByNamedQuerySystemAndObjectAndIdName("Trail.findByNamedQuerySystemAndObjectAndIdName", system, object, objectIdName, objectIdValue);
