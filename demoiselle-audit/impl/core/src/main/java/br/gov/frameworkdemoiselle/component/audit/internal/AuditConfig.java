 ...
 */
package br.gov.frameworkdemoiselle.component.audit.internal;
...
public class AuditConfig {
    ...
    public String toString() {
        return "AuditConfig{" + "urlServer=" + urlServer + ", folderFailObjects=" + folderFailObjects + ", schedulerStartTime=" + schedulerStartTime + ", schedulerRepeatInterval=" + schedulerRepeatInterval + ", system=" + system + '}';
    }
