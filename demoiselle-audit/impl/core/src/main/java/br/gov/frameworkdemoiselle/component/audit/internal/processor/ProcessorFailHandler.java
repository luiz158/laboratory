...
import br.gov.frameworkdemoiselle.component.audit.exception.AuditException;
...
public class ProcessorFailHandler {
	...
	protected void onFailProcessor(@Observes @AuditProcessorFailQualifier Trail trail) {
