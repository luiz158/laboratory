...
public class NotaListMB extends AbstractListPageBean<Nota, Long> {
	...
	private LazyDataModel<Nota> lazyDataModel = new LazyDataModel<Nota>() {
		 private static final long serialVersionUID = 1L;

	        @Override
	        public List<Nota> load(int first, int pageSize, String sortField,
	            ...
	            List<Nota> list = handleResultList();
	...
	public LazyDataModel<Nota> getLazyModel() {
