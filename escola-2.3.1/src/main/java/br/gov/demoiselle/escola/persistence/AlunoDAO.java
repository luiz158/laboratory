...
public class AlunoDAO extends JPACrud<Aluno, Long>{
	...
	public void alterarDetalhe(Object object) {
		getEntityManager().merge(object);
	}
	
	public Aluno buscarAluno(Usuario usuario) {			
		
		Query query = createQuery("from Aluno as aluno where aluno.usuario.id = " + usuario.getId());
		List<Aluno> retorno = query.getResultList();
