...
public class AnalyzeInterceptorTest {

	@Inject
	private Logger logger;

	/**
	 * Visiting non static declared fields including inherited fields. String, Class, primitive, or wrapped fields only.
	 */
	@Test
	public void case1() {
		logger.info("Running Case #1...");
		Beans.getReference(Case1.class).go();
	}
