...
public class CreateBusinessValidation implements Validation {
	
	private File project;
	private String line;

	public CreateBusinessValidation(File project, String line) {
	...
	public void validate() throws ValidationException {
		...
		if(params.length != 2){
			throw new ValidationException("Parâmetros inválidos, utilize: " + CommandsConstant.CREATE_BUSINESS + " <domínio>");
		}
