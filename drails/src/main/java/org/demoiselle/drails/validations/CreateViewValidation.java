...
public class CreateViewValidation implements Validation {

	private File project;
	private String line;

	public CreateViewValidation(File project, String line) {
	...
	public void validate() throws ValidationException {
		...
		if(params.length != 2){
			throw new ValidationException("Parâmetros inválidos, utilize: " + CommandsConstant.CREATE_VIEW + " <domínio>");
		}
