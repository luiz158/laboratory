...
@TableGenerator(name = "estacionamentoSequence", table = "sequencesEstacionamento", allocationSize = 1)
public class Estacionamento implements Serializable {
	...
	@GeneratedValue(generator = "estacionamentoSequence", strategy = TABLE)
	private Long id;
