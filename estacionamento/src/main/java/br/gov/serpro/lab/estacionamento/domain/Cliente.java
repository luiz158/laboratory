...
@Entity
@Table(name = "cliente")
@TableGenerator(name = "clienteSequence", table = "sequencesCliente", allocationSize = 1)
public class Cliente implements Serializable {
	...
	@GeneratedValue(generator = "clienteSequence", strategy = TABLE)
	private Long id;
	...
	public Cliente(final String nome, final String documento, final String telefone, final List<Automovel> automoveis) {
		this.nome = nome;
		this.documento = documento;
		this.telefone = telefone;
