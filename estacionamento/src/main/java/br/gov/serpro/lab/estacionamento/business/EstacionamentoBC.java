...
public class EstacionamentoBC extends DelegateCrud<Estacionamento, Long, EstacionamentoDAO> {
	...
	public void insert(Estacionamento estacionamento) {
		try {
			...
			messageContext.add(InfoMessages.ESTACIONAMENTO_INSERT_OK, estacionamento.getNome());
		} catch (TransactionException te) {
			messageContext.add(ErrorMessages.ESTACIONAMENTO_INSERT_NOK, te.getMessage(), SeverityType.ERROR);
		}
	}
	...
	public void update(Estacionamento estacionamento) {
		try {
			...
			messageContext.add(InfoMessages.ESTACIONAMENTO_UPDATE_OK, estacionamento.getNome());
		} catch (TransactionException te) {
			messageContext.add(ErrorMessages.ESTACIONAMENTO_UPDATE_NOK, te.getMessage(), SeverityType.ERROR);
		}
	}
	...
	public void delete(Long id) {
		try {
			super.delete(id);
			messageContext.add(InfoMessages.ESTACIONAMENTO_DELETE_OK, id);
		} catch (TransactionException te) {
			messageContext.add(ErrorMessages.ESTACIONAMENTO_DELETE_NOK, te.getMessage(), SeverityType.ERROR);
		}
	}
}
