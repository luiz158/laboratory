...
import br.gov.frameworkdemoiselle.prodepa.queryfilter.app.filter.AddressFilter;
import br.gov.frameworkdemoiselle.prodepa.queryfilter.app.filter.CommonFilter;
import br.gov.frameworkdemoiselle.prodepa.queryfilter.app.filter.PersonFilter;
...
public class EasyFilterParameterBuildTest extends AbstractTest {
  ...
  * */
  ...
  @Test
  public void testAddFiltersPersonAllStrings() throws EasyQueryFilterException {
    
    Map<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("param", "%a%");
    
    List<Person> personsFromJPQL = getListFromJPQL("select p from Person p where p.name like :param OR p.nickName like :param ", Person.class, parameters);

    EasyQuery<Person> easyCriteria = new EasyQueryImpl<Person>(Person.class, getEntityManager());

    CommonFilter filter = new CommonFilter();
    filter.setFilter("NickName");
    List<Person> easyCriteriaResult = easyCriteria.addAnnotatedFilter(filter).getResultList();
    
    System.out.println(easyCriteriaResult);

    assertTrue(personsFromJPQL.size() == 2);
    ...
    /*Upper case*/
    parameters.clear();
    parameters.put("param", "%NICKNAME%");
    filter.setFilter("NICKNAME");
    
    personsFromJPQL = getListFromJPQL("select p from Person p where UPPER(p.name) like :param OR UPPER(p.nickName) like :param ", Person.class, parameters);
    easyCriteriaResult = easyCriteria.addAnnotatedFilter(filter).getResultList();
    assertTrue(personsFromJPQL.size() == 2);
    assertEquals(personsFromJPQL.size(), easyCriteriaResult.size());
    assertTrue(personsFromJPQL.containsAll(easyCriteriaResult));
    ...
    personsFromJPQL = getListFromJPQL("select p from Person p where LOWER(p.name) like :param OR LOWER(p.nickName) like :param ", Person.class, parameters);
    easyCriteriaResult = easyCriteria.addAnnotatedFilter(filter).getResultList();
    assertTrue(personsFromJPQL.size() == 2);
    assertEquals(personsFromJPQL.size(), easyCriteriaResult.size());
    assertTrue(personsFromJPQL.containsAll(easyCriteriaResult));
    ...
    /*Natural Case*/
    parameters.clear();
    parameters.put("param", "%NickName A%");
    filter.setFilter("NickName A");
    personsFromJPQL = getListFromJPQL("select p from Person p where p.name like :param OR p.nickName like :param ", Person.class, parameters);
    easyCriteriaResult = easyCriteria.addAnnotatedFilter(filter).getResultList();
  ...
  @Test
  public void testAddFiltersAndEqUnique() throws EasyQueryFilterException {
    ...
    Person person = easyCriteria.addAnnotatedFilter(filter).getSingleResult();
  ...
  @Test
  public void testAddFiltersAndLike() throws EasyQueryFilterException {
    
    Map<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("param", "%"+CodeGenerator.PERSON01_NAME+"%");
    
    List<Person> personsFromJPQL = getListFromJPQL("select p from Person p where p.name like :param ", Person.class, parameters);

    EasyQuery<Person> easyCriteria = new EasyQueryImpl<Person>(Person.class, getEntityManager());
    
    //easyCriteria.andEquals("name", CodeGenerator.PERSON01_NAME);
    PersonFilter filter = new PersonFilter();
    filter.setName(CodeGenerator.PERSON01_NAME);
  ...
  @Test
  public void testAddFiltersAndLikeIgnoreCase() throws EasyQueryFilterException {
    
    Map<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("param", "%"+CodeGenerator.PERSON01_NAME.toLowerCase()+"%");
    
    List<Person> personsFromJPQL = getListFromJPQL("select p from Person p where LOWER(p.name) like :param ", Person.class, parameters);

    EasyQuery<Person> easyCriteria = new EasyQueryImpl<Person>(Person.class, getEntityManager());
    
    //easyCriteria.andEquals("name", CodeGenerator.PERSON01_NAME);
    PersonFilter filter = new PersonFilter();
    filter.setNomeIgnoreCase(CodeGenerator.PERSON01_NAME.toUpperCase());
  ...
  @Test
  public void testAddFiltersAndLike2Fields() throws EasyQueryFilterException {
    
    Map<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("param", "%"+CodeGenerator.PERSON01_NAME+"%");
    
    List<Person> personsFromJPQL = getListFromJPQL("select p from Person p where p.name like :param AND p.nickName like :param", Person.class, parameters);

    EasyQuery<Person> easyCriteria = new EasyQueryImpl<Person>(Person.class, getEntityManager());
    
    //easyCriteria.andEquals("name", CodeGenerator.PERSON01_NAME);
    PersonFilter filter = new PersonFilter();
    filter.setNomesAnd(CodeGenerator.PERSON01_NAME);
  ...
  @Test
  public void testAddFiltersAndSimple() throws EasyQueryFilterException {
    
    Map<String, Object> parameters = new HashMap<String, Object>();
    parameters.put("param", true);
    
    List<Person> personsFromJPQL = getListFromJPQL("select p from Person p where p.brazilian = :param ", Person.class, parameters);

    EasyQuery<Person> easyCriteria = new EasyQueryImpl<Person>(Person.class, getEntityManager());
    
    PersonFilter filter = new PersonFilter();
    filter.setBrazilian(true);
  ...
  @Test
  public void testAddFiltersOrLike2Fields() throws EasyQueryFilterException {
    ...
    //easyCriteria.andEquals("name", CodeGenerator.PERSON01_NAME);
    PersonFilter filter = new PersonFilter();
    filter.setNomesOr(CodeGenerator.PERSON01_NAME);
  ...
  /*
   * 
   * Re-Tests From EasyFilterTest.java 
   * 
   * @see EasyFilterTest.java
   * 
   */
  ...
  @Test
  public void isAddingOneWhereFloatEquals() throws EasyQueryFilterException {
  ...
  /* TODO Not Supported
  @Test
  public void isAddingOneOrFloatEquals() throws QueryFilterException {
  ...
  @Test
  public void isAddingOneWhereDoubleEquals() throws EasyQueryFilterException {
  ...
  @Test
  public void isAddingOneWhereLongEquals() throws EasyQueryFilterException {
    ...
    PersonFilter filter = new PersonFilter();
    filter.setSocialSecurityNumber(1928371L);
  ...
  @Test
  public void isAddingOneOrLongEqualsArray() throws EasyQueryFilterException {
    ...
    PersonFilter filter = new PersonFilter();
    filter.setSocialSecurityNumberArray(new Long[]{1928371L, 98723487L});
  ...
  @Test
  public void isAddingOneOrLongEqualsList() throws EasyQueryFilterException {
    List<Person> personsFromJPQL = getListFromJPQL("select p from Person p where p.socialSecurityNumber = 1928371 or p.socialSecurityNumber = 98723487", Person.class);
    assertTrue(personsFromJPQL.size() > 0);
    ...
    //easyCriteria.orEquals("socialSecurityNumber", 1928371L, 98723487L);
    PersonFilter filter = new PersonFilter();
    filter.setSocialSecurityNumberList(Arrays.asList(1928371L, 98723487L));
  ...
  @Test
  public void isAddingOneOrLongEqualsSet() throws EasyQueryFilterException {
    List<Person> personsFromJPQL = getListFromJPQL("select p from Person p where p.socialSecurityNumber = 1928371 or p.socialSecurityNumber = 98723487", Person.class);
    assertTrue(personsFromJPQL.size() > 0);
    ...
    numbers.add(1928371L);
    numbers.add(98723487L);
    
    filter.setSocialSecurityNumberSet(numbers);
  ...
  @Test
  public void isAddingOneWhereIntegerEquals() throws EasyQueryFilterException {
    List<Person> personsFromJPQL = getListFromJPQL("select p from Person p where p.shoesInCloset = 10", Person.class);
    assertTrue(personsFromJPQL.size() > 0);
    
    EasyQuery<Person> easyCriteria = new EasyQueryImpl<Person>(Person.class, getEntityManager());
    
    //easyCriteria.andEquals("shoesInCloset", 10);
    PersonFilter filter = new PersonFilter();
    filter.setShoesInCloset(10);
  ...
  @Test
  public void isAddingOneWhereIntegerEqualsWithoutAnnotation() throws EasyQueryFilterException {
  ...
  @Test
  public void isWhereNotEqualsWorking() throws EasyQueryFilterException {
  ...
  //TODO PROBLEMA: Object....
  @Test
  public void isOrNotEqualsWorking() throws EasyQueryFilterException {
      ...
      PersonFilter filter = new PersonFilter();
      filter.setNamesNotEqual(new String[]{"Anna", "Mary"});
  ...
  @Test
  public void isAddingSequentialWhereIntegerEquals() throws EasyQueryFilterException {
  ...
  @Test
  public void isAddingOneWhereEqualsString() throws EasyQueryFilterException {
      ...
      //easyCriteria.andEquals("name", CodeGenerator.PERSON01_NAME);
      PersonFilter filter = new PersonFilter();
      filter.setNameEqual(CodeGenerator.PERSON01_NAME);
  ...
  //TODO PROBLEMA: Object....
  @Test
  public void isAddingOneOrEqualsString() throws EasyQueryFilterException {
    ...
    PersonFilter filter = new PersonFilter();
    filter.setNamesEqual(new String[]{CodeGenerator.PERSON01_NAME, CodeGenerator.PERSON02_NAME});
  ...
  @Test
  public void isAddingSequentialWhereEqualsString() throws EasyQueryFilterException {
      ...
      PersonFilter filter = new PersonFilter();
      filter.setNameEqual(CodeGenerator.PERSON01_NAME);
      filter.setNickName(CodeGenerator.PERSON01_NICKNAME);
  ...
  @Test
  public void isAddingOneWhereDateEquals() throws ParseException, EasyQueryFilterException {
      ...
      PersonFilter filter = new PersonFilter();
      filter.setFirstJobDate(firstJobDate);
  ...
  @Test
  public void isAddingOneOrDateEquals() throws ParseException, EasyQueryFilterException {
      SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
      Date firstJobDate = formatter.parse("1/1/2015");
      ...
      PersonFilter filter = new PersonFilter();
      filter.setFirstJobDateList(Arrays.asList(firstJobDate, secondJobDate));
  ...
  @Test
  public void isAddingOneWhereCalendarEquals() throws ParseException, EasyQueryFilterException {
      SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
      ...
      PersonFilter filter = new PersonFilter();
      filter.setBirthDayDate(dateOfBirth);
  ...
  @Test
  public void isAddingSequentialWhereDateEquals() throws ParseException, EasyQueryFilterException {
      SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
      Date firstJobDate = formatter.parse("1/1/2015");
      ...
      PersonFilter filter = new PersonFilter();
      filter.setFirstJobDate(firstJobDate);
      filter.setFirstSoccerMatchDate(firstSoccerMatchDate);
  ...
  @Test
  public void isAddingSequentialWhereCalendarEquals() throws ParseException, EasyQueryFilterException {
      SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
      ...
      PersonFilter filter = new PersonFilter();
      filter.setBirthDayDate(birthDayCalendar);
      filter.setFirstKissDate(firstKiss);
  ...
  @Test
  public void isAddingOneWhereEqualsBoolean() throws EasyQueryFilterException {
  ...
  @Test
  public void isAddingSequentialWhereEqualsBoolean() throws EasyQueryFilterException {
  ...
  @Test
  public void isAddingObjectWhereEquals() throws EasyQueryFilterException {
  ...
  @Test
  public void isAddingSequentialWhereEquals() throws ParseException, EasyQueryFilterException {
      SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
      ...
      /*easyCriteria.andEquals("id", 2)
                  .andEquals("buildingDate", buildingDate)
                  .andEquals("isOld", false)
                  .andEquals("streetName", "Street B")
                  .andEquals("isYellow", true);*/

      AddressFilter filter = new AddressFilter();
      filter.setId(2);
      filter.setBuildingDate(buildingDate);
      filter.setIsOld(false);
      filter.setStreetName("Street B");
      filter.setIsYellow(true);

      List<Address> easyCriteriaResult = easyCriteria.addAnnotatedFilter(filter).getResultList();
  ...
  @Test
  public void isDoubleGreaterThanWorking() throws EasyQueryFilterException {
  ...
  @Test
  public void isDoubleGreaterOrEqualToWorking() throws EasyQueryFilterException {
  ...
  @Test
  public void isDoubleLessThanWorking() throws EasyQueryFilterException {
      List<Person> personsFromJPQL = getListFromJPQL("select p from Person p where p.height < 11.00d", Person.class);
  ...
  @Test
  public void isDoubleLessOrEqualToWorking() throws EasyQueryFilterException {
      List<Person> personsFromJPQL = getListFromJPQL("select p from Person p where p.height <= 11.00d", Person.class);
 ...
 /* @Test
  ...
  @Test
  public void isStringGreaterThanWorking() throws EasyQueryFilterException {
   ...
   */
    ...
    @Test //ok
    public void isIntegerBetweenWorking() throws EasyQueryFilterException {
        ...
        PersonFilter filter = new PersonFilter();
        filter.setShoesInClosetBetween(new Range<Integer>(9, 21));
    ...
    //OK
    @Test 
    public void isLongBetweenWorking() throws EasyQueryFilterException {
        ...
        PersonFilter filter = new PersonFilter();
        filter.setTotalBooksOwnedBetween(new Range<Long>(19L, 31L));
    ...
    //OK
    @Test
    public void isLongBetweenWorkingArray() throws EasyQueryFilterException {
        List<Person> personsFromJPQL = getListFromJPQL("select p from Person p where p.totalBooksOwned between 19 and 31", Person.class);
        ...
        //easyCriteria.andBetween("totalBooksOwned", 19L, 31L);
        PersonFilter filter = new PersonFilter();
        filter.setTotalBooksOwnedBetweenArray(new Long[]{19L, 31L});
    ...
    //OK
    @Test
    public void isLongBetweenWorkingList() throws EasyQueryFilterException {
        List<Person> personsFromJPQL = getListFromJPQL("select p from Person p where p.totalBooksOwned between 19 and 31", Person.class);
        ...
        //easyCriteria.andBetween("totalBooksOwned", 19L, 31L);
        PersonFilter filter = new PersonFilter();
        filter.setTotalBooksOwnedBetweenList(Arrays.asList(19L, 31L));
    ...
    //OK
    @Test
    public void isStringBetweenWorking() throws EasyQueryFilterException {
        ...
        PersonFilter filter = new PersonFilter();
        filter.setNameBetween(new Range<String>("a", "l"));
    ...
    @Test //OK
    public void isCalendarBetweenWorking() throws ParseException, EasyQueryFilterException {
        SimpleDateFormat formatter = new SimpleDateFormat("dd/MM/yyyy");
        ...
        PersonFilter filter = new PersonFilter();
        filter.setBirthDayDateBetween(new Range<Calendar>(valueA, valueB));
    ...
    @Test //OK
    public void isNullWorking() throws EasyQueryFilterException {
        ...
        filter1.setStringIsNull(true);
        
        EasyQuery<Person> personCriteria1 = new EasyQueryImpl<Person>(Person.class, getEntityManager());
        assertTrue(personCriteria1.addAnnotatedFilter(filter1).getResultList().size() == personsFromJPQL.size());
        assertTrue(personCriteria1.addAnnotatedFilter(filter1).getResultList().containsAll(personsFromJPQL));
        ...
        filter2.setDateIsNull(true);
        
        EasyQuery<Person> personCriteria2 = new EasyQueryImpl<Person>(Person.class, getEntityManager());
        assertTrue(personCriteria2.addAnnotatedFilter(filter2).getResultList().size() == personsFromJPQL.size());
        assertTrue(personCriteria2.addAnnotatedFilter(filter2).getResultList().containsAll(personsFromJPQL));
        ...
        filter3.setIntegerIsNull(true);
        
        EasyQuery<Person> personCriteria3 = new EasyQueryImpl<Person>(Person.class, getEntityManager());
        assertTrue(personCriteria3.addAnnotatedFilter(filter3).getResultList().size() == personsFromJPQL.size());
        assertTrue(personCriteria3.addAnnotatedFilter(filter3).getResultList().containsAll(personsFromJPQL));

        personsFromJPQL = getListFromJPQL("select p from Person p where p.car is null", Person.class);
        assertTrue(personsFromJPQL.size() > 0);

        //personCriteria4.andIsNull("car");
        PersonFilter filter4 = new PersonFilter();
        filter4.setCarIsNull(true);
        
        EasyQuery<Person> personCriteria4 = new EasyQueryImpl<Person>(Person.class, getEntityManager());
        assertTrue(personCriteria4.addAnnotatedFilter(filter4).getResultList().size() == personsFromJPQL.size());
        assertTrue(personCriteria4.addAnnotatedFilter(filter4).getResultList().containsAll(personsFromJPQL));
    }
    ...
    public void isListIsEmptyWorking() {
        ...
        assertTrue(easyCriteria.getResultList().size() == personsFromJPQL.size());
        assertTrue(easyCriteria.getResultList().containsAll(personsFromJPQL));
    }
    ...
    @Test //OK
    public void isStringLikeWorking() throws EasyQueryFilterException {
    ...
    @Test //OK
    public void isStringInWorking() throws EasyQueryFilterException {
        ...
        PersonFilter filter = new PersonFilter();
        filter.setNamesIn(names);

        EasyQuery<Person> easyCriteria = new EasyQueryImpl<Person>(Person.class, getEntityManager());
        
        easyCriteria.addAnnotatedFilter(filter);
    ...
    @Test
    public void isStringNotInWorking() throws EasyQueryFilterException {
    ...
    @Test
    public void isPaginationWorking() throws EasyQueryFilterException {
        ...
        List<Person> personsSecondResult = query.setFirstResult(2)
                                                .setMaxResults(1)
                                                .getResultList();
        ...
        PersonFilter filter = new PersonFilter();
        filter.setFirstResult(1L);
        filter.setMaxResults(1);

        List<Person> persons = easyCriteria.addAnnotatedFilter(filter).getResultList();
        assertEquals(persons.size(), personsFirstResult.size());
        assertTrue(persons.containsAll(personsFirstResult));

        
        EasyQuery<Person> easyCriteria2 = new EasyQueryImpl<Person>(Person.class, getEntityManager());
        //easyCriteria2.setFirstResult(2);
        //easyCriteria2.setMaxResults(1);
        PersonFilter filter2 = new PersonFilter();
        filter2.setFirstResult(2L);
        filter2.setMaxResults(1);
        persons = easyCriteria2.addAnnotatedFilter(filter2).getResultList();
    ...
    @Test //OK
    public void isStringBetweenLowerCaseWorking() throws EasyQueryFilterException {
        List<Person> personsFromJPQL = getListFromJPQL("select p from Person p where lower(p.name) between 'a' and 'l'", Person.class);
        ...
        PersonFilter filter = new PersonFilter();
        filter.setNameBetween(new Range<String>("A".toLowerCase(), "L".toLowerCase()));
    ...
    public void isStringLikeLowerCaseWorking() {
        ...
        EasyQuery<Person> easyCriteria = new EasyQueryImpl<Person>(Person.class, getEntityManager());
        easyCriteria.andStringLike(true, "name", "m%");
        assertTrue(easyCriteria.getResultList().size() == personsFromJPQL.size());
        assertTrue(easyCriteria.getResultList().containsAll(personsFromJPQL));
        ...
        easyCriteria = new EasyQueryImpl<Person>(Person.class, getEntityManager());
        easyCriteria.andStringLike(true, "name", "%y");
        assertTrue(easyCriteria.getResultList().size() == personsFromJPQL.size());
        assertTrue(easyCriteria.getResultList().containsAll(personsFromJPQL));
    }
    ...
    public void isStringNotLikeLowerCaseWorking() {
        ...
        EasyQuery<Person> easyCriteria = new EasyQueryImpl<Person>(Person.class, getEntityManager());
        easyCriteria.andStringNotLike(true, "name", "m%");
        assertTrue(easyCriteria.getResultList().size() == personsFromJPQL.size());
        assertTrue(easyCriteria.getResultList().containsAll(personsFromJPQL));
        ...
        easyCriteria = new EasyQueryImpl<Person>(Person.class, getEntityManager());
        easyCriteria.andStringNotLike(true, "name", "%y");
        assertTrue(easyCriteria.getResultList().size() == personsFromJPQL.size());
        assertTrue(easyCriteria.getResultList().containsAll(personsFromJPQL));
    }
    ...
    public void isStringInLowerCaseWorking() {
        ...
        EasyQuery<Person> easyCriteria = new EasyQueryImpl<Person>(Person.class, getEntityManager());
        easyCriteria.andStringIn(true, "name", names);
        assertTrue(easyCriteria.getResultList().size() == personsFromJPQL.size());
        assertTrue(easyCriteria.getResultList().containsAll(personsFromJPQL));
    }
    ...
    public void isStringNotInLowerCaseWorking() {
        ...
        EasyQuery<Person> easyCriteria = new EasyQueryImpl<Person>(Person.class, getEntityManager());
        easyCriteria.andStringNotIn(true, "name", names);
        assertTrue(easyCriteria.getResultList().size() == personsFromJPQL.size());
        assertTrue(easyCriteria.getResultList().containsAll(personsFromJPQL));
    }
