...
/**
 * The base implementation of the evento participante local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link br.gov.demoiselle.portal.evento.service.impl.EventoParticipanteLocalServiceImpl}.
 * </p>
 *
 ...
 * @generated
 */
public abstract class EventoParticipanteLocalServiceBaseImpl
	extends BaseLocalServiceImpl implements EventoParticipanteLocalService,
		IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link br.gov.demoiselle.portal.evento.service.EventoParticipanteLocalServiceUtil} to access the evento participante local service.
	 */
	...
	public EventoParticipante addEventoParticipante(
		EventoParticipante eventoParticipante) throws SystemException {
		eventoParticipante.setNew(true);

		return eventoParticipantePersistence.update(eventoParticipante, false);
	}
	 ...
	 */
	public EventoParticipante createEventoParticipante(
		long eventoParticipanteId) {
		return eventoParticipantePersistence.create(eventoParticipanteId);
	}
	...
	public EventoParticipante deleteEventoParticipante(
		long eventoParticipanteId) throws PortalException, SystemException {
		return eventoParticipantePersistence.remove(eventoParticipanteId);
	}
	...
	public EventoParticipante deleteEventoParticipante(
		EventoParticipante eventoParticipante) throws SystemException {
		return eventoParticipantePersistence.remove(eventoParticipante);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(EventoParticipante.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return eventoParticipantePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return eventoParticipantePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public EventoParticipante fetchEventoParticipante(long eventoParticipanteId)
		throws SystemException {
		return eventoParticipantePersistence.fetchByPrimaryKey(eventoParticipanteId);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public EventoParticipante getEventoParticipante(long eventoParticipanteId)
		throws PortalException, SystemException {
		return eventoParticipantePersistence.findByPrimaryKey(eventoParticipanteId);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return eventoParticipantePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<EventoParticipante> getEventoParticipantes(int start, int end)
		throws SystemException {
		return eventoParticipantePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getEventoParticipantesCount() throws SystemException {
		return eventoParticipantePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public EventoParticipante updateEventoParticipante(
		EventoParticipante eventoParticipante) throws SystemException {
		return updateEventoParticipante(eventoParticipante, true);
	}
	...
	public EventoParticipante updateEventoParticipante(
		...
		return eventoParticipantePersistence.update(eventoParticipante, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("br.gov.demoiselle.portal.evento.model.EventoParticipante",
			eventoParticipanteLocalService);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = eventoParticipantePersistence.getDataSource();
	...
	private EventoParticipanteLocalServiceClpInvoker _clpInvoker = new EventoParticipanteLocalServiceClpInvoker();
}